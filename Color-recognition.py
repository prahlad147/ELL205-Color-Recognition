...
vid = cv2.VideoCapture(0)                                                                      # VideoCapture() -> It is a function that is used to record real time video from webcam and we place the frame obtained in a variable called vid
